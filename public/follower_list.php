...
// 自分をフォローしているユーザー一覧（フォロワー）取得
// JOIN → follower_user_id と users.id を結合してフォロワーの情報を取得
...
<ul>
  ...
  <li>
    <a href="/profile.php?user_id=<?= $relationship['follower_user_id'] ?>">
      ...
      <?php if(!empty($relationship['follower_user_icon_filename'])): // アイコン表示 ?>
